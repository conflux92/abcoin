...
This mechanism has been integrated into Bitcore-Node-Abcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/conflux92/insight-api-abcoin#web-socket-api](https://github.com/conflux92/insight-api-abcoin#web-socket-api)
* API: [https://github.com/conflux92/insight-api-abcoin#instantsend-transactions](https://github.com/conflux92/insight-api-abcoin#instantsend-transactions)
...
By default, the Abcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Abcoin Core daemon:
