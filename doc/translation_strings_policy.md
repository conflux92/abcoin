...
This document provides guidelines for internationalization of the Abcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `abcoin_en.ts` remains unchanged.
