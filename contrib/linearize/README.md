# Linearize
Construct a linear, no-fork, best version of the Abcoin blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install abcoin_hash

https://github.com/conflux92/abcoin_hash
...
JSON-RPC server. Running `abcoind` or `abcoin-qt -server` will be sufficient.
...
* `input`: abcoind blocks/ directory containing blkNNNNN.dat
