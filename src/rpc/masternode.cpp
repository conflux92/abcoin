...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Abcoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "abcoin",               "masternode",             &masternode,             true,  {} },
    { "abcoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "abcoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "abcoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "abcoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "abcoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
