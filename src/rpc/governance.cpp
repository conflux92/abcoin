...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in abcoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("abcoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Abcoin features */
    { "abcoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "abcoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "abcoin",               "gobject",                &gobject,                true,  {} },
    { "abcoin",               "voteraw",                &voteraw,                true,  {} },
