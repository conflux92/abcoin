    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ABCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("ABCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ABCOIN-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("ABCOIN-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("ABCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ABCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ABCOIN-traditional"), QVariant("trad"));
