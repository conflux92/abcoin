...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Abcoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Abcoin and make it unusable. To
